...
var app = (function () {
    ...
    ***************************************************************************** */function v(e,n){var t={};for(var o in e)Object.prototype.hasOwnProperty.call(e,o)&&n.indexOf(o)<0&&(t[o]=e[o]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var r=0;for(o=Object.getOwnPropertySymbols(e);r<o.length;r++)n.indexOf(o[r])<0&&Object.prototype.propertyIsEnumerable.call(e,o[r])&&(t[o[r]]=e[o[r]]);}return t}const O={fallbackLocale:null,initialLocale:null,loadingDelay:200,formats:{number:{scientific:{notation:"scientific"},engineering:{notation:"engineering"},compactLong:{notation:"compact",compactDisplay:"long"},compactShort:{notation:"compact",compactDisplay:"short"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},warnOnMissingMessages:!0,ignoreTag:!0};function j(){return O}const k=writable(!1);let L;const T=writable(null);function x(e){return e.split("-").map(((e,n,t)=>t.slice(0,n+1).join("-"))).reverse()}function E(e,n=j().fallbackLocale){const t=x(e);return n?[...new Set([...t,...x(n)])]:t}function D(){return L}T.subscribe((e=>{L=e,"undefined"!=typeof window&&null!==e&&document.documentElement.setAttribute("lang",e);}));const M=T.set;T.set=e=>{if(function(e){if(null==e)return;const n=E(e);for(let e=0;e<n.length;e++){const t=n[e];if(u(t))return t}}(e)&&w(e)){const{loadingDelay:n}=j();let t;return "undefined"!=typeof window&&null!=D()&&n?t=window.setTimeout((()=>k.set(!0)),n):k.set(!0),b(e).then((()=>{M(e);})).finally((()=>{clearTimeout(t),k.set(!1);}))}return M(e)},T.update=e=>M(e(L));const Z=e=>{const n=Object.create(null);return t=>{const o=JSON.stringify(t);return o in n?n[o]:n[o]=e(t)}},C=(e,n)=>{const{formats:t}=j();if(e in t&&n in t[e])return t[e][n];throw new Error(`[svelte-i18n] Unknown "${n}" ${e} format.`)},G=Z((e=>{var{locale:n,format:t}=e,o=v(e,["locale","format"]);if(null==n)throw new Error('[svelte-i18n] A "locale" must be set to format numbers');return t&&(o=C("number",t)),new Intl.NumberFormat(n,o)})),J=Z((e=>{var{locale:n,format:t}=e,o=v(e,["locale","format"]);if(null==n)throw new Error('[svelte-i18n] A "locale" must be set to format dates');return t?o=C("date",t):0===Object.keys(o).length&&(o=C("date","short")),new Intl.DateTimeFormat(n,o)})),U=Z((e=>{var{locale:n,format:t}=e,o=v(e,["locale","format"]);if(null==n)throw new Error('[svelte-i18n] A "locale" must be set to format time values');return t?o=C("time",t):0===Object.keys(o).length&&(o=C("time","short")),new Intl.DateTimeFormat(n,o)})),_=(e={})=>{var{locale:n=D()}=e,t=v(e,["locale"]);return G(Object.assign({locale:n},t))},q=(e={})=>{var{locale:n=D()}=e,t=v(e,["locale"]);return J(Object.assign({locale:n},t))},B=(e={})=>{var{locale:n=D()}=e,t=v(e,["locale"]);return U(Object.assign({locale:n},t))},H=Z(((e,n=D())=>new IntlMessageFormat(e,n,j().formats,{ignoreTag:j().ignoreTag}))),K=(e,n={})=>{"object"==typeof e&&(e=(n=e).id);const{values:t,locale:o=D(),default:r}=n;if(null==o)throw new Error("[svelte-i18n] Cannot format a message without first setting the initial locale.");let i=a(e,o);if(i){if("string"!=typeof i)return console.warn(`[svelte-i18n] Message with id "${e}" must be of type "string", found: "${typeof i}". Gettin its value through the "$format" method is deprecated; use the "json" method instead.`),i}else console.warn(`[svelte-i18n] The message "${e}" was not found in "${E(o).join('", "')}".${w(D())?"\n\nNote: there are at least one loader still registered to this locale that wasn't executed.":""}`),i=r||e;if(!t)return i;let l=i;try{l=H(i,o).format(t);}catch(n){console.warn(`[svelte-i18n] Message "${e}" has syntax error:`,n.message);}return l},Q=(e,n)=>B(n).format(e),R=(e,n)=>q(n).format(e),V=(e,n)=>_(n).format(e),W=(e,n=D())=>a(e,n),X=derived([T,s],(()=>K));derived([T],(()=>Q));derived([T],(()=>R));derived([T],(()=>V));derived([T,s],(()=>W));
    ...
    const file$6 = "src/components/home/Sidebar.svelte";
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "class", "svelte-wvfrkg");
    			add_location(a0, file$6, 14, 12, 322);
    			attr_dev(a1, "href", "#portfolio");
    			attr_dev(a1, "class", "svelte-wvfrkg");
    			add_location(a1, file$6, 15, 12, 369);
    			attr_dev(a2, "href", "#contact");
    			attr_dev(a2, "class", "svelte-wvfrkg");
    			add_location(a2, file$6, 16, 12, 424);
    			attr_dev(p, "class", "svelte-wvfrkg");
    			add_location(p, file$6, 13, 8, 267);
    			attr_dev(div, "class", "svelte-wvfrkg");
    			add_location(div, file$6, 12, 4, 253);
    		},
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			hr = element("hr");
    			add_location(hr, file$6, 20, 4, 509);
    		},
    		m: function mount(target, anchor) {
    ...
    const file$5 = "src/components/home/Nav.svelte";
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$5, 42, 20, 1191);
    			attr_dev(h2, "class", "titleh2 svelte-rncd0m");
    			add_location(h2, file$5, 43, 20, 1249);
    			attr_dev(div, "class", "titlewrapper svelte-rncd0m");
    			add_location(div, file$5, 41, 16, 1089);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h1);
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$5, 18, 16, 463);
    			attr_dev(a0, "href", "#homepage");
    			add_location(a0, file$5, 17, 12, 425);
    			...
    			add_location(img1, file$5, 21, 16, 607);
    			attr_dev(a1, "href", "#!");
    			add_location(a1, file$5, 20, 13, 542);
    			attr_dev(div0, "class", "rapper svelte-rncd0m");
    			add_location(div0, file$5, 16, 12, 392);
    			attr_dev(div1, "class", "navwrapper svelte-rncd0m");
    			add_location(div1, file$5, 24, 12, 716);
    			attr_dev(div2, "class", "topnavwrapper svelte-rncd0m");
    			add_location(div2, file$5, 15, 8, 352);
    			attr_dev(nav0, "class", "smallscreen svelte-rncd0m");
    			add_location(nav0, file$5, 14, 0, 318);
    			...
    			add_location(img2, file$5, 38, 20, 973);
    			attr_dev(a2, "href", "#homepage");
    			attr_dev(a2, "class", "svelte-rncd0m");
    			add_location(a2, file$5, 37, 16, 932);
    			attr_dev(div3, "class", "logowrapper svelte-rncd0m");
    			add_location(div3, file$5, 36, 12, 890);
    			attr_dev(a3, "href", "#about");
    			attr_dev(a3, "class", "svelte-rncd0m");
    			add_location(a3, file$5, 48, 16, 1406);
    			attr_dev(a4, "href", "#portfolio");
    			attr_dev(a4, "class", "svelte-rncd0m");
    			add_location(a4, file$5, 49, 16, 1457);
    			attr_dev(a5, "href", "#contact");
    			attr_dev(a5, "class", "svelte-rncd0m");
    			add_location(a5, file$5, 50, 16, 1516);
    			attr_dev(div4, "class", "myLinks svelte-rncd0m");
    			add_location(div4, file$5, 47, 12, 1368);
    			attr_dev(div5, "class", "topnav svelte-rncd0m");
    			add_location(div5, file$5, 34, 4, 851);
    			attr_dev(nav1, "class", "bigscreen svelte-rncd0m");
    			add_location(nav1, file$5, 33, 0, 823);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$3 = "src/components/clientwork/ClientWork.svelte";
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "svelte-124kktg");
    			add_location(p, file$3, 21, 7, 569);
    			attr_dev(a, "href", "https://berkeleychalmers.se/");
    			attr_dev(a, "class", "svelte-124kktg");
    			add_location(a, file$3, 25, 7, 621);
    			add_location(div, file$3, 20, 5, 516);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, p);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-124kktg");
    			add_location(h1, file$3, 11, 1, 251);
    			if (img0.src !== (img0_src_value = /*berkeley*/ ctx[3])) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "xmo logo");
    			add_location(img0, file$3, 14, 3, 352);
    			add_location(br0, file$3, 16, 26, 445);
    			attr_dev(h20, "class", "svelte-124kktg");
    			add_location(h20, file$3, 16, 4, 423);
    			attr_dev(h30, "class", "svelte-124kktg");
    			add_location(h30, file$3, 17, 4, 470);
    			attr_dev(div0, "class", "textwrapper svelte-124kktg");
    			add_location(div0, file$3, 15, 3, 393);
    			attr_dev(div1, "class", "card svelte-124kktg");
    			add_location(div1, file$3, 13, 2, 299);
    			if (img1.src !== (img1_src_value = /*truck*/ ctx[4])) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "truck on road");
    			add_location(img1, file$3, 32, 3, 783);
    			add_location(br1, file$3, 34, 21, 873);
    			attr_dev(h21, "class", "svelte-124kktg");
    			add_location(h21, file$3, 34, 4, 856);
    			attr_dev(h31, "class", "svelte-124kktg");
    			add_location(h31, file$3, 35, 4, 909);
    			attr_dev(div2, "class", "textwrapper svelte-124kktg");
    			add_location(div2, file$3, 33, 3, 826);
    			attr_dev(div3, "class", "card svelte-124kktg");
    			add_location(div3, file$3, 31, 2, 724);
    			attr_dev(div4, "class", "cardwrapper svelte-124kktg");
    			add_location(div4, file$3, 12, 1, 271);
    			attr_dev(section, "id", "portfolio");
    			attr_dev(section, "class", "svelte-124kktg");
    			add_location(section, file$3, 10, 0, 225);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class ClientWork extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { open: 0, openibm: 1 });
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			br3 = element("br");
    			t13 = text(t13_value);
    			add_location(br0, file$2, 7, 18, 126);
    			add_location(br1, file$2, 7, 23, 131);
    			add_location(u0, file$2, 7, 65, 173);
    			add_location(u1, file$2, 7, 100, 208);
    			attr_dev(h3, "class", "svelte-1800kef");
    			add_location(h3, file$2, 7, 1, 109);
    			add_location(br2, file$2, 9, 2, 262);
    			add_location(br3, file$2, 9, 6, 266);
    			attr_dev(p, "class", "svelte-1800kef");
    			add_location(p, file$2, 8, 1, 244);
    			attr_dev(div0, "class", "centerwrapper svelte-1800kef");
    			add_location(div0, file$2, 6, 1, 80);
    			attr_dev(div1, "id", "about");
    			attr_dev(div1, "class", "svelte-1800kef");
    			add_location(div1, file$2, 5, 0, 62);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$_*/ 1 && t0_value !== (t0_value = /*$_*/ ctx[0]("hi") + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*$_*/ 1 && t4_value !== (t4_value = /*$_*/ ctx[0]("I'm Samuel. Gothenburg based") + "")) set_data_dev(t4, t4_value);
    			if (dirty & /*$_*/ 1 && t6_value !== (t6_value = /*$_*/ ctx[0]("Software Engineer") + "")) set_data_dev(t6, t6_value);
    			if (dirty & /*$_*/ 1 && t8_value !== (t8_value = /*$_*/ ctx[0]("Multi creator") + "")) set_data_dev(t8, t8_value);
    			if (dirty & /*$_*/ 1 && t11_value !== (t11_value = /*$_*/ ctx[0]("p1") + "")) set_data_dev(t11, t11_value);
    			if (dirty & /*$_*/ 1 && t13_value !== (t13_value = /*$_*/ ctx[0]("p2") + "")) set_data_dev(t13, t13_value);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function create_fragment(ctx) {
    	...
    	footer = new Footer({
    			props: { value: /*$locale*/ ctx[0] },
    			$$inline: true
    		});

    	footer.$on("locale-changed", /*locale_changed_handler*/ ctx[1]);
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$locale*/ 1) footer_changes.value = /*$locale*/ ctx[0];
